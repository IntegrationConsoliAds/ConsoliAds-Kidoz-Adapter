...
Pod::Spec.new do |s|
  ...
  s.version          = '8.9.0-1.0'
  s.summary          = 'This pod is used to get kidoz adapter for kidozad serving after integrating Consoliads-Mediation pod.'
...
#   * Finally, don't worry about the indent, CocoaPods strips it!
  ...
  s.description      = <<-DESC
  'This pod is used to get kidoz adapter for kidozad serving after integrating Consoliads-Mediation pod.'
                       DESC
